...
class WeatherPopulated extends StatelessWidget {
  WeatherPopulated({required Weather weather, super.key})
      : _coordinates = weather.coordinates,
        ...
        _tempUnit =
            weather.metadata.units.airTemperature == 'celsius' ? "°C" : "°F",
        _fogUnit = weather.metadata.units.fogAreaFraction,
        _precipitationUnit = weather.metadata.units.precipitationAmount,
        _ultraVioletIndexClearSkyUnit =
            weather.metadata.units.ultraVioletIndexClearSky,
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text(
            "Precipitation amount: ${_weatherDetails.precipitationAmount}$_precipitationUnit"),
        Text(
            "Ultra violet index clear sky: ${_weatherDetails.ultraVioletIndexClearSky}$_ultraVioletIndexClearSkyUnit"),
